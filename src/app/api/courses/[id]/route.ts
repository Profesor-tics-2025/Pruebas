...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: "Error loading course", details: String(error) }, { status: 500 });
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ error: "Error updating course", details: String(error) }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: "Error deleting course", details: String(error) }, { status: 500 });
  }
}
